...
def compare_search_algorithms():
    ...
    print("-" * 80)
    print(f"{'Parameter':<25}{'Interpolation Search':<25}{'Binary Search'}")
    print("-" * 80)
    print(f"{'Best Time':<25}{'O(1)':<25}{'O(1)'}")
    print(f"{'Average Time':<25}{'O(log log n)':<25}{'O(log n)'}")
    print(f"{'Worst Time':<25}{'O(n)':<25}{'O(log n)'}")
    print(f"{'Space Complexity':<25}{'O(1)':<25}{'O(1)'}")
# --- Main ---
