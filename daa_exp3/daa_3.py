...
def compare_algorithms():
    ...
    print("Reason: Sorting all edges takes O(E log E), and Union-Find stores parent and rank arrays.")

    print("\nPrim's Algorithm:")
    print("Time Complexity : O(E log V)")
    print("Space Complexity: O(V + E)")
    print("Reason: Priority Queue (Min Heap) is used to select the minimum edge efficiently.")
